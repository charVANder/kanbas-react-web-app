    ...
    return(
        <div id="wd-forms">
            ...
            <form id="wd-text-fields">
                ...
                <input type="number" id="wd-text-fields-salary-start" placeholder="1000" min={500} max={10000}/>
                <br/>
                <label htmlFor="wd-text-fields-telephone"> Phone Number:</label>
                <input type="tel" id="wd-text-fields-telephone" placeholder="123-234-3456"/>
                <br/>
                <label htmlFor="wd-text-fields-rating"> Rating: </label>
                <input type="range" id="wd-text-fields-rating" placeholder="Doe" max="5"/>
                <br/>
